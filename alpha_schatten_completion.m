...
%Matrix completion with RSVM-SN for different s
%Martin Sundin, 2014-06-29
tic;

%Data is saved as filename.mat
filename = 'alpha_schatten_completion1_test1';
...
legend(['RSVM-SN, s =  ' num2str(s1)],['RSVM-SN, s =  ' num2str(s2)],['RSVM-SN, s =  ' num2str(s3)],['RSVM-SN, s =  ' num2str(s4)],['RSVM-SN, s =  ' num2str(s5)],'Location','Best');
ylabel('NMSE [dB]');
xlabel('m/pq');
